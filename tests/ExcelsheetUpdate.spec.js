...
test('Upload download excel validation', async ({ page }) => {
  ...
  writeExcelTest(textSearch, updateValue, { rowChange: 0, colChange: 2 }, "C:/Users/Malaprabha/Downloads/download.xlsx");
  await page.locator("#fileinput").click();
  await page.locator("#fileinout").setInputFiles("C:/Users/Malaprabha/Downloads/download.xlsx");
